    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-phone-outline"></i> 售后管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-button v-if="userPower.indexOf('7000')>-1" type="success" icon="el-icon-plus" @click="handleADD('add')">增加售后订单</el-button>
            </div>
            <el-table :data="tableData" border style="font-size:10px" stripe class="table" ref="multipleTable" header-cell-class-name="table-header" :show-header='true' @cell-click="showSOInfo" @selection-change="handleSelectionChange" height="63vh">
                ...
                <el-table-column prop="pdNum" label="售后编号" width="120" :show-overflow-tooltip="true"></el-table-column>
        ...
        <!-- 增加弹出框 -->
        <el-dialog title="维修保养单" align='center' :before-close="partClose" :visible.sync="addVisible" width="60vw">
            <el-form :model="ADDform" :rules="rules" id = "ADDform" ref="ADDform" label-width="100px" class="demo-ruleForm">
                <div style="margin:-40px 0 -15px 0;"> 
                    <el-form-item label=" 编号(No.)：" prop="pdNum">
                        <el-input v-model="ADDform.pdNum" placeholder="请输入编号"></el-input>
                    </el-form-item>
                </div>
                <el-row style="border:1px solid #000;text-align:left;">
                    <div class="tab_title"><i class="el-icon-bank-card"></i> 报修信息</div>
                    <el-row style="border:1px solid #000;margin:2px;">
                        <el-col class="list_unit b_b" :span="8">
                            <el-form-item label="报修人：" prop="pdNum">
                                <el-input v-model="ADDform.pdNum" placeholder="请输入报修人"></el-input>
                            </el-form-item>
                        </el-col> 
                        <el-col class="list_unit b_b" :span="8">
                            <el-form-item label="维保地点：" prop="customerName">
                                <el-input v-model="ADDform.customerName" placeholder="请输入维保地点"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col class="list_unit b_b" :span="8">
                            <el-form-item label="设备型号：" prop="customerName">
                                <el-input v-model="ADDform.customerName" placeholder="请输入设备型号"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col class="list_unit b_b" :span="8">
                            <el-form-item label="报修部门：" prop="pdNum">
                                <el-input v-model="ADDform.pdNum" placeholder="请输入报修部门"></el-input>
                            </el-form-item>
                        </el-col> 
                        <el-col class="list_unit b_b" :span="8">
                            <el-form-item label="报修时间：" prop="customerName">
                                <el-date-picker v-model="ADDform.pdDate" value-format="yyyy-MM-dd" type="date" placeholder="选择报修时间"></el-date-picker>
                            </el-form-item>
                        </el-col>                        
                        <el-col class="list_unit b_b" :span="8">
                            <el-form-item label="设备序列号：" prop="customerName">
                                <el-input v-model="ADDform.pdNum" placeholder="请输入设备序列号"></el-input>
                            </el-form-item>
                        </el-col>
                       
                        <el-col class="list_unit" :span="8">
                            <el-form-item label="设备开机日期：" prop="customerName">
                                <el-date-picker v-model="ADDform.pdDate" value-format="yyyy-MM-dd" type="date" placeholder="选择售后日期"></el-date-picker>
                            </el-form-item>
                        </el-col>
                        <el-col class="list_unit" :span="8">
                            <el-form-item label="是否溯源：" prop="traceability">
                                <el-radio-group v-model="ADDform.customerName">
                                    <el-radio label="1">内</el-radio>
                                    <el-radio label="2">外</el-radio>
                                    <el-radio label="3">其他(借机)</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        </el-col>    
                        <el-col class="list_unit" :span="8">
                            <el-form-item label="维保类型：" prop="traceability">
                                <el-radio-group v-model="ADDform.customerName">
                        ...
                        <el-col class="list_unit  b_t" style="padding-top:10px" :span="24">
                             <el-form-item label="报修问题描述：" prop="remark">
                                <el-input v-model="ADDform.remark" type="textarea" :rows="2" placeholder="" style="width:99%;"></el-input>
                            </el-form-item>
                        </el-col>    
                    </el-row>

                    <div class="tab_title"><i class="el-icon-bank-card"></i> 维保信息</div>
                    <el-row style="border:1px solid #000;margin:2px;"><el-col class="list_unit" :span="8">
                            <el-form-item label="维保人：" prop="customerName">         
                                <el-input v-model="ADDform.pdNum" placeholder="请输维保人"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col class="list_unit" :span="8">
                            <el-form-item label="维保部门：" prop="traceability">                                
                                <el-input v-model="ADDform.pdNum" placeholder="请输入维保部门"></el-input>
                            </el-form-item>
                        </el-col>    
                        <el-col class="list_unit" :span="8">
                            <el-form-item label="维保时间：" prop="traceability">
                                <el-date-picker v-model="ADDform.pdDate" value-format="yyyy-MM-dd" type="date" placeholder="选择售后日期"></el-date-picker>
                            </el-form-item>
                        </el-col> 
                        <el-col class="list_unit  b_t" style="padding-top:10px" :span="24">
                             <el-form-item label="维保情况描述：" prop="remark">
                                <el-input v-model="ADDform.remark" type="textarea" :rows="2" placeholder="" style="width:99%;"></el-input>
                            </el-form-item>
                        </el-col> 
                    </el-row>
                    <div style="display: flex; flex-wrap: wrap;height:206px;">
                        <div class="tab_title3">更换部件</div>
                        <div style="width:80%;height:207px;overflow:auto;">
                                <div class="tab_title2">
                                    <el-col class="list_unit" :span="2">序号</el-col>
                                    <el-col class="list_unit" :span="17">部件描述</el-col> 
                                    <el-col class="list_unit" :span="5">数量</el-col>
                                </div>

                                <el-row style="border:1px solid #000;margin:2px;">
                                    <el-col class="list_unit b_r tc" :span="2">1</el-col>
                                    <el-col class="list_unit b_r tc" :span="17">
                                        <el-input v-model="ADDform.pdNum" placeholder="请输入部件描述"></el-input>
                                    </el-col> 
                                    <el-col class="list_unit tc" :span="5">
                                        <el-input v-model="ADDform.pdNum" placeholder="请输入数量"></el-input>
                                    </el-col>
                                </el-row>
                                <el-row style="border:1px solid #000;margin:2px;">
                                    <el-col class="list_unit b_r tc" :span="2">1</el-col>
        ...
        <!-- 展示弹出框 -->
        <el-dialog title="售后订单" align='center' :before-close="partClose" :visible.sync="showVisible" width="60vw">
                <el-row style="border:1px solid #000;text-align:left;">
                    <div class="tab_title"><i class="el-icon-bank-card"></i> 订单信息</div>
                    <el-row style="border:1px solid #000;margin:2px;">
                        <el-col class="list_unit b_b pl15" :span="8">售后编号：{{showInfoform.pdNum}}</el-col>
                        <el-col class="list_unit b_b" :span="8">售后日期：{{showInfoform.pdDate}}</el-col> 
    ...
    data() {
        return {
            ...
            rules: {
                ...
                pdDate: [
                    { required: true, message: '请选择售后日期', trigger: 'blur' }
                ],
                deliverTime: [
