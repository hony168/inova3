    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-button v-if="userPower.indexOf('7000')>-1" type="success" icon="el-icon-plus" @click="handleADD">增加供应商</el-button>
            </div>
            <el-table :data="tableData" border style="font-size:10px" stripe class="table" ref="multipleTable" header-cell-class-name="table-header" :show-header='true' @selection-change="handleSelectionChange" height="63vh">
                ...
                <el-table-column prop="id" label="供应商ID" width="80"  :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="name" label="供应商名称" :show-overflow-tooltip="true"></el-table-column>
                ...
                <el-table-column prop="place" label="职务" width="80" align="center" :show-overflow-tooltip="true"></el-table-column>
        ...
        <!-- 编辑弹出框 -->
        <el-dialog title="供应商编辑" align='center' :before-close="partClose" :visible.sync="editVisible" width="50vw">
            <el-form ref="editForm" id="editForm" :model="editForm" :rules="rules" label-width="100px" class="demo-ruleForm">
                <el-row style="border:1px solid #000;text-align:left;">
                    <div class="tab_title"><i class="el-icon-bank-card"></i> 供应商信息</div>
        ...
        <!-- 增加物料弹出框 -->
        <el-dialog title="供应商增加" align='center' :before-close="partClose" :visible.sync="addVisible" width="50vw">
...
export default {
    ...
    methods: {
        ...
        addContact(formName) {
            ...
            self.ADDform.type=2;//供应商的类型 1为客户  2为供应商
        ...
        saveEdit(formName) {
            ...
            self.editForm.type=2;//供应商的类型 1为客户  2为供应商
            self.$refs[formName].validate((valid) => {
                if (valid) {
